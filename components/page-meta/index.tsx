...
export default function PageMeta({ page }: Props) {
    ...
    return (
        <header className='border-b border-gray-200 mb-6'>
            <span className='inline-block text-gray-400 font-semibold uppercase text-xs mb-4'>About_</span>
            <h1 className={`${beVietnamPro.variable} font-title text-3xl md:text-4xl pb-4`}>{title}</h1>
