<main class="flex-1 flex flex-col items-center justify-center w-full px-6 space-y-6 pb-6 mt-4 md:mt-8">
    <section class='w-full max-w-[640px]'>
        ...
        <div class="content">
          ...
          <p>In my spare time, I enjoy tinkering with technology (currently SvelteKit, Prisma, WebComponents and generative AI), hanging out with the family, cycling with friends, making cocktails, and cooking outside.</p>
